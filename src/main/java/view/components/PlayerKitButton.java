...
public class PlayerKitButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (kitImage != null) {
            // Draw kit image centered
            int x = (getWidth() - KIT_WIDTH) / 2;
            g2d.drawImage(kitImage, x, 0, KIT_WIDTH, KIT_HEIGHT, this);
        } else {
